...
# **zone_test_3.sh** - VM with 2xNIC (high bandwidth)
...
ZONE_PORT_ID1=$(create_zone_port $ZONE_NET_NAME1 $ZONE_NETWORK_CIDR1 $ZONE_PORT_GBPS1 $ZONE_PORT_ZONE1)
ZONE_PORT_ID2=$(create_zone_port $ZONE_NET_NAME2 $ZONE_NETWORK_CIDR2 $ZONE_PORT_GBPS2 $ZONE_PORT_ZONE2)
